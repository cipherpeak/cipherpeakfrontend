...
const LeaveApplications = () => {
                ...
                <div className="flex items-center justify-between">
                    ...
                    {selectedApplication.status === 'pending' && (
                        <div className="flex gap-2">
                            ...
                            <Button
                                onClick={() => handleApproveReject(selectedApplication.id, 'reject')}
                                disabled={processing}
                                variant="destructive"
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <Card className="border-none shadow-sm rounded-xl">
                            ...
                            <CardContent className="space-y-8 pt-4">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm font-bold text-[#333]">
                                            {selectedApplication.monthly_leave_count || 0} leaves in Current Month
                                        </span>
                                    </div>
                                </div>
                                ...
                                {/* Passport Required */}
                                {(selectedApplication.passport_required_from || selectedApplication.passport_required_to) && (
                                    <div className="grid grid-cols-2 gap-x-12 gap-y-8">
                                        <div className="space-y-3">
                                            <p className="text-[11px] font-bold text-gray-400 uppercase tracking-tight">Passport Required From</p>
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-lg bg-[#fff3e0] flex items-center justify-center shrink-0">
                                                    <User className="h-5 w-5 text-[#ffb74d]" />
                                                </div>
                                                <span className="text-sm font-bold text-[#333]">{selectedApplication.passport_required_from || 'N/A'}</span>
                                            </div>
                                        </div>
                                        <div className="space-y-3">
                                            <p className="text-[11px] font-bold text-gray-400 uppercase tracking-tight">Passport Required To</p>
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-lg bg-[#fff3e0] flex items-center justify-center shrink-0">
                                                    <User className="h-5 w-5 text-[#ffb74d]" />
                                                </div>
                                                <span className="text-sm font-bold text-[#333]">{selectedApplication.passport_required_to || 'N/A'}</span>
                                            </div>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-3">
                                        ...
                                        <div className="p-3.5 rounded-lg border border-[#f0f0f0] bg-white min-h-[50px]">
                                            <p className="text-[13px] text-gray-500 font-medium">{selectedApplication.reason}</p>
                                        </div>
                                    </div>
                                    {selectedApplication.address_during_leave && (
                                        <div className="space-y-3">
                                            <p className="text-[11px] font-bold text-gray-400 uppercase tracking-tight">Address During Leave</p>
                                            <div className="p-3.5 rounded-lg border border-[#f0f0f0] bg-white min-h-[50px]">
                                                <p className="text-[13px] text-gray-500 font-medium">{selectedApplication.address_during_leave}</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                                ...
                                {selectedApplication.attachment && (
                                    <div className="space-y-3 mt-8">
                                        <p className="text-[11px] font-bold text-gray-400 uppercase tracking-tight">Attachment</p>
                                        <div className="flex items-center gap-4 p-4 bg-[#f8fbff] rounded-lg border border-[#edf3f9]">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-[11px] font-semibold text-gray-400">File Attached</p>
                                            </div>
                                            <Button
                                                variant="outline"
                                                size="sm"
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="border-none shadow-sm rounded-xl relative">
                            <CardHeader className="pb-2 flex-row items-center justify-between">
                                ...
                                <Button variant="outline" size="sm" className="h-7 text-[#42a5f5] border-[#42a5f5] hover:bg-blue-50 px-3 rounded-md text-[10px] font-bold bg-white">
                            ...
                            <CardContent className="pt-4 px-6 pb-6">
                                ...
                                <div className="mt-8 space-y-5">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <p className="text-[12px] font-bold text-[#333]">
                                            <span className="text-gray-400 font-medium mr-2">Branch:</span>
                                            {selectedApplication.employee_details?.branch || 'Not Set'}
                                        </p>
                                    </div>
                        ...
                        <Card className="border-none shadow-sm rounded-xl mt-6">
                            ...
                            <CardContent className="pt-4 space-y-6 pb-8">
                                ...
                                {selectedApplication.status === 'pending' ? (
                                    ...
                                    <div className="flex gap-4">
                                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${selectedApplication.status === 'approved' ? 'bg-[#2e7d32]' : 'bg-[#d32f2f]'}`}>
                                            {selectedApplication.status === 'approved' ? <CheckCircle2 className="h-4 w-4 text-white" /> : <XCircle className="h-4 w-4 text-white" />}
                                        </div>
                                        <div>
                                            <p className="text-[12px] font-bold text-[#1e1e1e]">
                                                {selectedApplication.status === 'approved' ? 'Approved' : 'Rejected'} by {selectedApplication.approved_by_name || 'Admin'}
                                            </p>
                                            <p className="text-[10px] font-bold text-gray-400 mt-0.5">
    ...
    const stats = [
        ...
        { label: 'Approved', value: applications.filter(a => a.status === 'approved').length, icon: CheckCircle, color: 'text-green-500', bg: 'bg-green-50' },
                            ...
                            {applications.length === 0 ? (
                                ...
                                applications.map((app) => (
                                    <tr key={app.id} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <p className="text-[12px] font-bold text-[#333] mb-0.5">{app.leave_type}</p>
                                            <p className="text-[10px] font-medium text-gray-400">{formatDate(app.start_date)} to {formatDate(app.end_date)}</p>
                                        </td>
                                        <td className="px-6 py-4">
                                            <p className="text-[12px] font-bold text-[#333]">{app.employee_details?.designation || 'Service'}</p>
                                        </td>
                                        <td className="px-6 py-4">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <Button
                                                    variant="outline"
                                                    size="sm"
                                                    className={`h-8 w-8 p-0 rounded-lg border-gray-100 text-green-600 bg-white hover:bg-green-50 shadow-sm ${app.status !== 'pending' ? 'opacity-50 cursor-not-allowed' : ''}`}
                                                    onClick={() => app.status === 'pending' && handleApproveReject(app.id, 'approve')}
                                                ...
                                                <Button
                                                    variant="outline"
                                                    size="sm"
                                                    className={`h-8 w-8 p-0 rounded-lg border-gray-100 text-red-600 bg-white hover:bg-red-50 shadow-sm ${app.status !== 'pending' ? 'opacity-50 cursor-not-allowed' : ''}`}
                                                    onClick={() => app.status === 'pending' && handleApproveReject(app.id, 'reject')}
                                                    disabled={processing || app.status !== 'pending'}
                                                    title="Reject"
                                                >
